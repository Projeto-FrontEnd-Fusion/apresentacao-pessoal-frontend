  ...
  const Skills = () => (
    <section className="skills my-8 p-4 bg-gray-100">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {skills.map((skill) => (
          <div key={skill.name} className="skill-card flex flex-col items-center p-4 bg-white rounded shadow-md hover:shadow-lg transition-shadow duration-300">
            <div className="mb-4 text-blue-500 text-4xl">{skill.icon}</div>
